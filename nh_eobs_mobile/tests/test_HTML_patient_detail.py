...
class TestPatientDetailHTML(MobileHTMLRenderingCase):
    """Test case collecting all the tests relating to the RENDERING of the
    'patient detail' page.
    ...
    def test_patient_detail_page_with_no_data(self):
        """Test the 'patient detail' page with only information
        about the patient (no observations' information)."""
        ...
        # Set up specific data to provide the template
        # the data it needs for the rendering
        api_data = {
        ...
        # This way it's 'string-comparable' with the fixture
        # file parsed above.
    ...
    def test_patient_detail_page_with_observations_data(self):
        ...
        """
        # Retrieve the fixture for this test and parse it,
        # thus there is an expected output to compare
        # the mobile controller's method's result against
    ...
    def test_patient_detail_page_with_observations_data_and_notification(self):
        ...
        compressed_expected_output = self._compress_string(expected_output)
        # Add the 'doctype' string (before compressing) as a small fix for the
        #  comparison's sake
        compressed_rendered_parsed = self._compress_string(
            '<!DOCTYPE html>'+rendered_and_parsed)
