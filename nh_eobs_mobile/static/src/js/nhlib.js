...
(function() {
  ...
  NHMobilePatient = (function(_super) {
    ...
    NHMobilePatient.prototype.draw_graph = function(self, server_data) {
      var bp_graph, context, element_for_chart, focus, obs, oxy_graph, pulse_graph, resp_rate_graph, score_graph, svg, tabular_obs, temp_graph;
      ...
      if (obs.length > 0) {
        ...
        return document.getElementById('graph-content').parentNode.getElementsByClassName('tabs')[0].style.display = 'none';
      }
    };
