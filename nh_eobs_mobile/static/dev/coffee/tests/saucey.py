...
browsers = [
    ...
    ['Mac 10.9', 'iPhone', '7.0'], # PASSES
    ['Linux', 'Android', '4.0'], # PASSES
    # ['Linux', 'Android', '4.1'], # Fails to get JSReporter
    ['Linux', 'Android', '4.2'], # PASSES
    # ['Linux', 'Android', '4.4'], # not working as can't getJSReporter for some reason
    ['Windows 2008', 'Internet Explorer', '9'], # PASSES
    ['Windows 2008', 'Internet Explorer', '10'], # PASSES
    ['Windows 2012 R2', 'Internet Explorer', '11'], # PASSES
    ['Windows 2008', 'Firefox', '24'], # PASSES
    ['Windows 2008', 'Chrome', '26'] # PASSES
]
test_suite_url = 'http://cbt.openeobs.net/nh_eobs_mobile/static/dev/coffee/tests/SpecRunner1.3.html'
