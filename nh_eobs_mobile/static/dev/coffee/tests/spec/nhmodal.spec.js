describe('NHModal', function(){
	...
	it('creates a dialog object', function(){
		...
		expect(test_modal.innerHTML).toEqual('<h2>title</h2><div class="dialogContent" style="max-height: 375px;">content</div><ul class="options one-col"><li><a href="#" data-action="close" data-target="id">Option</a></li></ul>');
	});
	...
	it('creates a dialog object with two options', function(){
		...
		var test_modal = document.getElementById('id');
		expect(test_modal.innerHTML).toEqual('<h2>title</h2><div class="dialogContent" style="max-height: 375px;">content</div><ul class="options two-col"><li><a href="#" data-action="close" data-target="id">Option 1</a></li><li><a href="#" data-action="confirm" data-target="id">Option 2</a></li></ul>');
	});
	...
	it('creates a dialog object with three options', function(){
		...
		var test_modal = document.getElementById('id');
		expect(test_modal.innerHTML).toEqual('<h2>title</h2><div class="dialogContent" style="max-height: 375px;">content</div><ul class="options three-col"><li><a href="#" data-action="close" data-target="id">Option 1</a></li><li><a href="#" data-action="confirm" data-target="id">Option 2</a></li><li><a href="#" data-action="confirm" data-target="id">Option 3</a></li></ul>');
	});
	...
	it('creates a dialog object with four options', function(){
		...
		var test_modal = document.getElementById('id');
		expect(test_modal.innerHTML).toEqual('<h2>title</h2><div class="dialogContent" style="max-height: 375px;">content</div><ul class="options four-col"><li><a href="#" data-action="close" data-target="id">Option 1</a></li><li><a href="#" data-action="confirm" data-target="id">Option 2</a></li><li><a href="#" data-action="confirm" data-target="id">Option 3</a></li><li><a href="#" data-action="confirm" data-target="id">Option 4</a></li></ul>');
	});
    ...
    it('dialogContent is resized correctly when it exceeds the window height', function(){
        ...
        var modal = new window.NHModal('id', 'title', 'content', ['<a href="#" data-action="close" data-target="id">Option</a>'], 0, document.getElementById('test'))
        var test_modal = document.getElementById('id');
        expect(test_modal.innerHTML).toEqual('<h2>title</h2><div class="dialogContent" style="max-height: 175px;">content</div><ul class="options one-col"><li><a href="#" data-action="close" data-target="id">Option</a></li></ul>');
    });
