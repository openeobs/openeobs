# -*- coding: utf-8 -*-
#
# nh_eobs_mobile documentation build configuration file, created by
...
htmlhelp_basename = 'nh_eobs_mobiledoc'
...
latex_documents = [
  (master_doc, 'nh_eobs_mobile.tex', u'nh\\_eobs\\_mobile Documentation',
...
man_pages = [
    (master_doc, 'nh_eobs_mobile', u'nh_eobs_mobile Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'nh_eobs_mobile', u'nh_eobs_mobile Documentation',
   author, 'nh_eobs_mobile', 'One line description of project.',
   'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    # 'ews': ('https://nh-ews.readthedocs.org/en/develop/', None)
}
