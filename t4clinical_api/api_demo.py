...
class t4_clinical_api_demo(orm.AbstractModel):
    ...
    def create_pos_location(self, cr, uid):
        data = self.data_pos_location(cr, uid)
    ...
    def create_bed_location(self, cr, uid):
        data = self.data_bed_location(cr, uid)
        location_pool = self.pool['t4.clinical.location']
        location_id = location_pool.create(cr, uid, data)
    ...
    def create_ward_location(self, cr, uid):
        data = self.data_ward_location(cr, uid)
        location_pool = self.pool['t4.clinical.location']
        location_id = location_pool.create(cr, uid, data)
