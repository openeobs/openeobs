...
class TestObservationReportRendering(helpers.ObservationReportHelpers):
    ...
    def test_02_report_footer_structure(self):
        """
        Test that the report footer is rendering correctly with the username,
        ...
        self.assertTrue(
            footer_has_hosp_name, 'Incorrect hosp name in footer')
        self.assertTrue(
    ...
    def test_03_report_page_structure(self):
        ...
        containing the patient details and graph and the other pages with
        data tables
        """
        report_data = {
            'spell_id': 1,
