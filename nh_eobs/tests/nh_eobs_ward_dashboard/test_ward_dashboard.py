...
class TestWardDashboard(SingleTransactionCase):
    ...
    def test_01_get_bed_ids(self):
        ...
        res = self.ward_pool._get_bed_ids(
            cr, uid, [self.ward_id, self.ward_id2], 'bed_ids', {})
    ...
    def test_02_get_wm_ids(self):
        ...
        res = self.ward_pool._get_wm_ids(
            cr, uid, [self.ward_id, self.ward_id2], 'assigned_wm_ids', {})
        self.assertTrue(isinstance(res, dict))
    ...
    def test_03_get_dr_ids(self):
        ...
        res = self.ward_pool._get_dr_ids(
            cr, uid, [self.ward_id, self.ward_id2], 'assigned_doctor_ids', {})
        self.assertTrue(isinstance(res, dict))
    ...
    def test_04_get_hca_ids(self):
        ...
        res = self.bed_pool._get_hca_ids(
            cr, uid, self.beds, 'assigned_hca_ids', {})
        self.assertTrue(isinstance(res, dict))
    ...
    def test_05_get_nurse_ids(self):
        ...
        res = self.bed_pool._get_nurse_ids(
            cr, uid, self.beds, 'assigned_nurse_ids', {})
        self.assertTrue(isinstance(res, dict))
    ...
    def test_07_get_nurse_follower_ids(self):
        ...
        res = self.bed_pool._get_nurse_follower_ids(
            cr, uid, self.beds, 'nurse_follower_ids', {})
        self.assertTrue(isinstance(res, dict))
        self.assertFalse(res[self.beds[0]])
        self.assertFalse(res[self.beds[1]])
    ...
    def test_08_get_hca_follower_ids(self):
        ...
        res = self.bed_pool._get_hca_follower_ids(
            cr, uid, self.beds, 'hca_follower_ids', {})
        self.assertTrue(isinstance(res, dict))
        self.assertFalse(res[self.beds[0]])
        self.assertFalse(res[self.beds[1]])
    ...
    def test_09_ward_dashboard_data(self):
        ...
        self.assertEqual(ward.location_id.id, self.ward_id,
                         msg='Incorrect location_id field')
        self.assertEqual(ward.waiting_patients, 0,
                         msg='Incorrect waiting_patients field')
        self.assertEqual(ward.patients_in_bed, 3,
                         msg='Incorrect patients_in_bed field')
        self.assertEqual(ward.free_beds, 0,
                         msg='Incorrect free_beds field')
        self.assertEqual(ward.related_hcas, 1,
                         msg='Incorrect related_hcas field')
        self.assertEqual(ward.related_nurses, 1,
                         msg='Incorrect related_nurses field')
        self.assertEqual(ward.related_doctors, 1,
                         msg='Incorrect related_doctors field')
        self.assertEqual(ward.kanban_color, 7,
                         msg='Incorrect kanban_color field')
        self.assertEqual(ward.high_risk_patients, 0,
                         msg='Incorrect high_risk_patients field')
        self.assertEqual(ward.med_risk_patients, 0,
                         msg='Incorrect med_risk_patients field')
        self.assertEqual(ward.low_risk_patients, 0,
                         msg='Incorrect low_risk_patients field')
        self.assertEqual(ward.no_risk_patients, 0,
                         msg='Incorrect no_risk_patients field')
        self.assertEqual(ward.noscore_patients, 3,
                         msg='Incorrect noscore_patients field')

    def test_10_ward_dashboard_acuity_board(self):
        cr, uid = self.cr, self.uid
        ir_model_pool = self.registry('ir.model.data')

        kanban_view_id = ir_model_pool.get_object_reference(
            cr, uid, 'nh_eobs', 'view_wardboard_kanban')[1]
        tree_view_id = ir_model_pool.get_object_reference(
            cr, uid, 'nh_eobs', 'view_wardboard_tree')[1]
        form_view_id = ir_model_pool.get_object_reference(
