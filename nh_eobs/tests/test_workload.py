...
class TestWorkload(SingleTransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.patients = [cls.api.register(
            cr, cls.adt_uid, 'HN000', {'given_name': 'giventest',
    ...
    def test_01_get_groups(self):
        ...
        groups = [(10, '46- minutes'), (20, '45-31 minutes remain'),
                  (30, '30-16 minutes remain'), (40, '15-0 minutes remain'),
                  (50, '1-15 minutes late'), (60, '16+ minutes late')]
        groups.reverse()
    ...
    def test_02_data(self):
        ...
        self.assertEqual(wk_data['data_model'],
