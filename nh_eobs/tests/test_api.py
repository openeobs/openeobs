...
class TestAPI(SingleTransactionCase):
    ...
    def test_start_and_stop_following(self):
        ...
        self.assertTrue(follow.activity_id.id in self.extapi.get_assigned_activities(cr, self.nu_id, activity_type='nh.clinical.patient.follow'), msg="Get assigned activities not returning the follow activity just created.")
