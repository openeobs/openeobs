...
class TestWardDashboardMenuItem(MenuItemCase):
    """
    Test that the Ward Dashboard menu item is shown or hidden for various
    user groups
    """
    ...
    def setUp(self):
        ...
        Set up the tests
        """
        super(TestWardDashboardMenuItem, self).setUp()
        self.allowed_groups = \
            self.get_groups_for_menu_item('Ward Dashboard')
