...
class TestWardManagementMenuItem(MenuItemCase):
    """
    Test that the Ward Management menu header is shown or hidden for various
    user groups
    """
    ...
    def setUp(self):
        ...
        Set up the tests
        """
        super(TestWardManagementMenuItem, self).setUp()
        self.allowed_groups = \
            self.get_groups_for_menu_item('Ward Management')
