...
class ObservationReport(models.AbstractModel):
    ...
    def render_html(self, data=None):
        ...
        # set up data
        start_time = datetime.strptime(data.start_time, dtf) if data.start_time else False
        end_time = datetime.strptime(data.end_time, dtf) if data.end_time else False
