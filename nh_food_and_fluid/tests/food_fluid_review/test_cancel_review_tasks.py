...
class TestCancelReviewTasks(TransactionCase):
    ...
    def call_test(self):
        ...
        self.food_and_fluid_review_model.cancel_review_tasks(cancel_reason)
    ...
    def test_cancels_all_review_tasks_for_spell(self):
        ...
        states_before = [self.f_and_f_review_activity.state] + \
                        [f_and_review_activity_2.state]
        self.assertEqual(states_before, ['new'] * 2)

        self.call_test()

        states_after = [self.f_and_f_review_activity.state] + \
                       [f_and_review_activity_2.state]
