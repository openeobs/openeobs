...
class TestStaffAllocationComplete(SingleTransactionCase):
    ...
    @classmethod
    def setUpClass(cls):
        super(TestStaffAllocationComplete, cls).setUpClass()
    ...
    def setUp(self):
        ...
        super(TestStaffAllocationComplete, self).setUp()
    ...
    def tearDown(self):
        super(TestStaffAllocationComplete, self).tearDown()
