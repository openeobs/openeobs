...
class test_adt(common.SingleTransactionCase):
    ...
    def test_adt_admit(self):
        ...
        # Create
        admit_activity = env_pool.create_activity(cr, adt_user_id, env_id,'nh.clinical.adt.patient.admit', {}, admit_data, no_fake=True)
        # activity test
        ...
        # test spell
        spell_activity = [a for a in admission_activity.created_ids if a.data_model == 'nh.clinical.spell']
    ...
    def test_adt_discharge(self):
        ...
        discharge_activity = env_pool.create_activity(cr, uid, env_id, 'nh.clinical.adt.patient.discharge', {}, {'other_identifier': patient.other_identifier}, True)
    ...
    def test_adt_register(self):
        ...
        # Create
        register_activity = env_pool.create_activity(cr, adt_user_id, env_id,'nh.clinical.adt.patient.register', {}, register_data, no_fake=True)
        # activity test
