...
class TestGetNextScheduledTime(TransactionCase):
    """
    ...
    def setUp(self):
        ...
        Set up the tests
        """
        super(TestGetNextScheduledTime, self).setUp()
    ...
    def tearDown(self):
        ...
        """
        self.weight_model._revert_method('get_current_time')
        super(TestGetNextScheduledTime, self).tearDown()
