function myNews(respRate, spo2, o2Flag, temp, systolic, pulse, avpu) {
...
JSC.claim(
    "NEWS",
    function(verdict, respRate, spo2,o2Flag,temp, systolic, pulse, avpu){


        return verdict(news(respRate,spo2,o2Flag,temp,systolic,pulse,avpu).newsScore == myNews(respRate,spo2,o2Flag,temp,systolic,pulse,avpu))
