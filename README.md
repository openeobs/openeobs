...
We currently develop against [our own tag of Odoo](https://github.com/openeobs/odoo/tree/liveobs_1.11.1), this is to ensure consistency so it's recommended when installing Odoo that you install this version.
