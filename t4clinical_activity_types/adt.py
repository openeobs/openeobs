    ...
    def complete(self, cr, uid, activity_id, context=None):
        ...
        if spell_activity_id:
            ...
            admission_activity_id = admission_pool.create_activity(cr, SUPERUSER_ID,{
                ...
                'pos_id': update_activity.data_ref.suggested_location_id.pos_id.id,
                'patient_id': update_activity.patient_id.id,
                'suggested_location_id': update_activity.data_ref.suggested_location_id.id}, context=context)
            res[admission_pool._name] = admission_activity_id
