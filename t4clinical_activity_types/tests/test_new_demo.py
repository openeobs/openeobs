...
#         register_activity_id = api_demo.create_activity(cr, adt_uid, 't4.clinical.adt.patient.register')
#         register_data = api.get_activity_data(cr, uid, register_activity_id)
#         
#         ward_location_id = api_demo.create(cr, uid, 't4.clinical.location', 'location_ward', {'pos_id': pos_id})
#         ward_location = api.location_map(cr, uid, location_ids=[ward_location_id])[ward_location_id]
#         
#         admit_activity_id = api_demo.create_activity(cr, adt_uid, 't4.clinical.adt.patient.admit')
#         
...
#         
#         bed_location_id = api_demo.create(cr, uid, 't4.clinical.location', 'location_bed', {'patent_id': ward_location_id})
