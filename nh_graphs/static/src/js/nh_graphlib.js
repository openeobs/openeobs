...
(function() {
  ...
  NHGraphLib = (function() {
    function NHGraphLib(element) {
      this.redraw_resize = bind(this.redraw_resize, this);
      this.mobile_time_end_change = bind(this.mobile_time_end_change, this);
      this.mobile_time_start_change = bind(this.mobile_time_start_change, this);
      this.mobile_date_end_change = bind(this.mobile_date_end_change, this);
      this.mobile_date_start_change = bind(this.mobile_date_start_change, this);
      this.leading_zero = bind(this.leading_zero, this);
      this.date_to_string = bind(this.date_to_string, this);
      this.date_from_string = bind(this.date_from_string, this);
      var self;
      this.style = {
        margin: {
          top: 40,
    ...
    NHGraphLib.prototype.draw_table = function(self) {
      ...
      return cells = rows.selectAll('td').data(function(d) {
        var data, fix_val, j, k, key, len, len1, o, obj, ref, ref1, t, v;
        data = [
          {
            title: d['title'],
            value: d['title']
  ...
  NHFocus = (function() {
    ...
    NHFocus.prototype.init = function(parent_svg) {
      var graph, j, k, len, len1, ref, ref1, self, table, top_offset;
      if (parent_svg != null) {
        this.parent_obj = parent_svg;
        if (this.title != null) {
    ...
    NHFocus.prototype.draw = function(parent_svg) {
      var graph, j, k, len, len1, ref, ref1, table;
      ref = this.graphs;
      for (j = 0, len = ref.length; j < len; j++) {
        graph = ref[j];
        graph.draw(this);
  ...
  NHGraph = (function() {
    function NHGraph() {
      ...
      this.draw = bind(this.draw, this);
      this.init = bind(this.init, this);
      this.rangify_graph = bind(this.rangify_graph, this);
    ...
    NHGraph.prototype.init = function(parent_obj) {
      var j, key, left_offset, len, line_self, ob, ref, ref1, self, top_offset, values;
      ...
      if ((ref1 = self.parent_obj.parent_obj.options.controls.rangify) != null) {
    ...
    NHTable.prototype.draw = function(parent_obj) {
      ...
      self.data_rows.selectAll('tr').data(function() {
        ...
        data_to_use = (function() {
          var k, len1, results;
          results = [];
          for (k = 0, len1 = data_map.length; k < len1; k++) {
            data = data_map[k];
            if (data != null) {
              results.push(data);
            }
